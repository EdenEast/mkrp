...
impl From<enigo::Key> for Key {
    fn from(value: enigo::Key) -> Self {
        match value {
            ...
            enigo::Key::VolumeDown => todo!(),
            enigo::Key::VolumeMute => todo!(),
            enigo::Key::VolumeUp => todo!(),
